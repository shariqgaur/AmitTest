...
function saucelabsbm(_ref7) {
	var saucelabsUsername = _ref7.saucelabsUsername;
	var saucelabsAuthToken = _ref7.saucelabsAuthToken;
...
function travisci(_ref9) {
	var githubSlug = _ref9.githubSlug;
...
function codeship(_ref10) {
	var codeshipProjectUUID = _ref10.codeshipProjectUUID;
	var codeshipProjectID = _ref10.codeshipProjectID;
...
function coveralls(_ref11) {
	var githubSlug = _ref11.githubSlug;
...
function paypal(_ref17) {
	var paypalURL = _ref17.paypalURL;
	var paypalButtonID = _ref17.paypalButtonID;
	var paypalUsername = _ref17.paypalUsername;
...
function bitcoin(_ref18) {
	var bitcoinURL = _ref18.bitcoinURL;
...
function wishlist(_ref19) {
	var wishlistURL = _ref19.wishlistURL;
...
function slackinscript(_ref20) {
	var slackinURL = _ref20.slackinURL;
...
function gabeacon(_ref22) {
	var gaTrackingID = _ref22.gaTrackingID;
	var githubSlug = _ref22.githubSlug;
...
function facebooklike(_ref26) {
	...
	var facebookApplicationID = _ref26.facebookApplicationID;
...
function facebookfollow(_ref27) {
	var facebookUsername = _ref27.facebookUsername;
...
function twittertweet(_ref28) {
	var twitterUsername = _ref28.twitterUsername;
...
function githubfollow(_ref30) {
	var githubUsername = _ref30.githubUsername;
...
function githubstar(_ref31) {
	var githubSlug = _ref31.githubSlug;
...
function quorafollow(_ref32) {
	var quoraUsername = _ref32.quoraUsername;
	var quoraRealname = _ref32.quoraRealname;
	var quoraCode = _ref32.quoraCode;
